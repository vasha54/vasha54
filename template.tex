...
%\phone[fixed]{}
%\phone[fax]{}
\email{luis.valido1989@gmail.com}                               % optional, remove / comment the line if not wanted
%\homepage{}                         % optional, remove / comment the line if not wanted

% Social icons
\social[linkedin]{luis-andrés-valido-fajardo-539460204}                        % optional, remove / comment the line if not wanted
...
\include{tex_files/cv_es}

\pagebreak

\include{tex_files/cv_en}
