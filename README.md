...
<img src="https://github.com/vasha54/vasha54/blob/main/img/python.png" title="Python"  width="50" height="50"> *Strong experience in Python development within the Odoo ecosystem (versions 12 to 18), including customization of existing models, creation of custom modules from scratch, generation of complex PDF and Excel reports, consumption of external APIs for data migration, and configuration of automated scheduled tasks. Additionally, proficient in data analysis and scientific computing libraries such as Pandas, NumPy, Matplotlib, SciPy, and Statsmodels for implementing desktop applications focused on building and evaluating multiple linear regression models. Experienced in developing system utilities for managing, monitoring, and verifying processes in Unix environments, as well as solving competitive programming challenges. Capable of designing robust solutions that combine complex business logic, statistical processing, and integration with external RESTful services.*
